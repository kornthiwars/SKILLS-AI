...
| Situation | Skill |
|-----------|--------|
| Review touches architecture / past decisions | [`/vault-recall`](../vault-recall/SKILL.md) **before** verdict — check `vault/projects/*/decisions/` for conflicts |
...
- If the PR touches **policy, API contract, auth, or architecture** — run [`/vault-recall`](../vault-recall/SKILL.md) first to surface prior `vault/projects/*/decisions/` that may conflict.
