...
| Recall-friendly episodic summary | `/vault-capture` | `vault/projects/<project>/sessions/<topic>.md` |
...
Before drafting, run `/vault-recall` when prior `vault/projects/*/decisions/` may constrain the fix narrative.
...
| 5 AUTOLOG | [`vault-autolog.mdc`](../../ai-rules/workflow/vault-autolog.mdc): `Read` `templates/vault/notes/template.vault-daily.md` if missing → `append-daily -Project <slug>` (fix summary); reply **`Vault daily: updated vault/projects/{slug}/daily/YYYY-MM-DD.md`** |
