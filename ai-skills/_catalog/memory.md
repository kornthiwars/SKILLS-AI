# Skill catalog — Memory (vault)

Domain index (not a Cursor skill). Vault is local Obsidian notes (gitignored).

| Skill | Invoke | Role |
|-------|--------|------|
| [vault-capture](../vault-capture/SKILL.md) | `/vault-capture` | Session / ADR + project hub |
