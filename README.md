...
| vault-capture | `/vault-capture` | 2.3.5 | Session/ADR · infer project · auto hub |
| vault-recall | `/vault-recall` | 2.4.3 | grep-vault / Read · cite line range |
| vault-daily | `/vault-daily` | 2.2.3 | End-of-day triage · Issues · promote |
